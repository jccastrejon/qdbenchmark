...
public class QdBenchmarkDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class QualitySpecificationElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cSubCharacteristicsAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cSubCharacteristicsQualitySubCharacteristicParserRuleCall_2_0 = (RuleCall)cSubCharacteristicsAssignment_2.eContents().get(0);
		...
		public Assignment getSubCharacteristicsAssignment_2() { return cSubCharacteristicsAssignment_2; }

		//QualitySubCharacteristic
		public RuleCall getSubCharacteristicsQualitySubCharacteristicParserRuleCall_2_0() { return cSubCharacteristicsQualitySubCharacteristicParserRuleCall_2_0; }
	...
	public class Set_Elements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cDataModelAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final RuleCall cDataModelDataModelParserRuleCall_3_1_0 = (RuleCall)cDataModelAssignment_3_1.eContents().get(0);
		...
		private final Assignment cQualitySpecificationsAssignment_4_3 = (Assignment)cGroup_4.eContents().get(3);
		private final RuleCall cQualitySpecificationsQualitySpecificationParserRuleCall_4_3_0 = (RuleCall)cQualitySpecificationsAssignment_4_3.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_4_4 = (Keyword)cGroup_4.eContents().get(4);
		
		//Set_:
		//	"Set" name=ID ("[" attributes+=Attribute* "]")? ("<" dataModel=DataModel ">")? ("{" entities+=Entity* ","
		...
		//dataModel=DataModel
		public Assignment getDataModelAssignment_3_1() { return cDataModelAssignment_3_1; }

		//DataModel
		public RuleCall getDataModelDataModelParserRuleCall_3_1_0() { return cDataModelDataModelParserRuleCall_3_1_0; }

		//">"
		public Keyword getGreaterThanSignKeyword_3_2() { return cGreaterThanSignKeyword_3_2; }

		//("{" entities+=Entity* "," qualitySpecifications+=QualitySpecification* "}")?
		...
		//qualitySpecifications+=QualitySpecification*
		public Assignment getQualitySpecificationsAssignment_4_3() { return cQualitySpecificationsAssignment_4_3; }

		//QualitySpecification
		public RuleCall getQualitySpecificationsQualitySpecificationParserRuleCall_4_3_0() { return cQualitySpecificationsQualitySpecificationParserRuleCall_4_3_0; }
